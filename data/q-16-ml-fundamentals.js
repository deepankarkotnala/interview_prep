...
window.IR.q["16-ml-fundamentals"] = {
  ...
  "cards": [
    ...
    },
    {
      ...
      "numbers": "Typical full fine-tuning learning rates are 1e-5 to 5e-5 (LoRA adapters usually higher, around 1e-4 to 2e-4); pre-training uses higher with warmup. A diverging loss most often means the learning rate is too high.",
    ...
    },
    {
      ...
      "points": [
        ...
        "Tensor parallel: split large layer computations across devices.",
        "Pipeline parallel: split layers into stages across devices.",
        "FSDP: shard model/training state while keeping a data-parallel style.",
    ...
    },
    {
      ...
      "say": "I separate candidate generation from ranking. The first stage cheaply retrieves a few hundred plausible items and is tuned for recall. A second model uses richer user, item and context features to rank that smaller set, followed by business constraints such as diversity or inventory. I am careful with click labels because exposure and position create bias, and I have a cold-start path. Offline ranking metrics narrow choices, but the final decision comes from an online experiment with business and guardrail metrics.",
