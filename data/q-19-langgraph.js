...
window.IR.q["19-langgraph"] = {
  ...
  "cards": [
    ...
    },
    {
      ...
      "points": [
        "`stream_mode=\"messages\"` - LLM tokens from every model call in the graph; filter by node metadata to show only the answer.",
        "`stream_mode=\"updates\"` - one event per node, for progress UI.",
        "`stream_mode=\"custom\"` - your own progress events from inside a node, e.g. via `get_stream_writer()`.",
