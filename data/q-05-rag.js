...
window.IR.q["05-rag"] = {
  ...
  "cards": [
    ...
    },
    {
      ...
      "say": "I choose chunking from the document structure and the questions users ask, not from a framework default. I keep natural boundaries such as sections, clauses or code units, use parent-child retrieval when I need small search units but larger answer context, and treat tables or scans separately. Overlap is only a tuning knob. I run retrieval and answer evals, then choose the smallest chunks that preserve meaning without creating lots of duplicate context.",
