  ...
  "cards": [
    ...
    },
    {
      ...
      "points": [
        ...
        "8-bit (INT8/FP8) is usually near-free; INT4 is usually acceptable with real edge cases.",
    ...
    },
    {
      ...
      "numbers": "Cached input tokens are billed at a large discount versus uncached. Default cache lifetimes are typically minutes, with extended options on some providers, so benefit depends on request frequency.",
    ...
    },
    {
      ...
      "say": "I separate model from hosting first - open weights can sit behind hosted APIs, and closed models can run in-region. Then residency and contractual constraints, which can decide it immediately. Then quality on our own evaluation set, not benchmark headlines. After that I model economics: self-hosting has fixed GPU and operating cost while an API is mostly variable usage cost. I also weigh latency, rate limits, upgrade control and operating skill. I choose the simplest option that meets them and revisit with measured volume.",
